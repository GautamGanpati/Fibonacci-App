    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newUserTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(LoginActivity.this, com.xelp.miniproject.RegisterActivity.class);
                startActivity(i);
            }
        });
                ...
                mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Intent i = new Intent(LoginActivity.this, com.xelp.miniproject.MainActivity.class);
                            startActivity(i);
                            finish();
                        } else {
